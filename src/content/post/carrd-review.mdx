...
WordPress is a versatile and widely-used platform, but it can be more complex than Carrd and may not be the best choice for users seeking a straightforward landing page builder. WordPress sites needs constant mainenance and updates and even if WordPress is free you need to pay for hosting.
