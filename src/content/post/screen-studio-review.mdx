---
publishDate: 2023-04-04T5:00:00Z
...
- **Wallpaper & Window Frame** - You can add backgrounds to your videos, you can add a wallpaper, image, color or gradient.
- **Record Camera** - Screen Studio has an option to record the camera on your system, it has a nice anymation when you zoom in and you can change the position.
...
The Screen Studio editor will allow you to edit the video and add zooms or mouse tracking, convert the video to any size you want. Screen Studio is a complete video editor that will help you make nicer videos with little effort.
...
<Picture src={img1} widths={[200, 400, 900]} sizes="(max-width: 900px) 100vw, 900px" alt="Screen Studio Interface" />
...
<Picture src={img2} widths={[200, 400, 900]} sizes="(max-width: 900px) 100vw, 900px" alt="Screen Studio Export" />
