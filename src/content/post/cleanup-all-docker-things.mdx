---
publishDate: 2023-08-16T5:00:00Z
...
I have started doing that but in the beggining I only cleaned the images and volums had an issue and so on. In below steps you will find everything you need to do a proper docker cleanup to install the new images fresh.
