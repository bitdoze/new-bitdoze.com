...
<Picture src={img2} widths={[200, 400, 900]} sizes="(max-width: 900px) 100vw, 900px" alt="Clodflare DNS settings" />
...
✔ Where would you like to create your new project? … fratica.ro
...
✔ TypeScript settings applied!
  ...
  next   Liftoff confirmed. Explore your project!
         ...
         Enter your project directory using cd ./fratica.ro
...
Be sure that Where would you like to create your new project? to add the exact folder with the domain name you deleted.
