---
publishDate: 2023-03-17T07:00:00Z
...
<YouTubeEmbed url="https://www.youtube.com/embed/RNnuXCUhHF4" label="How To Install Plausible  With One Click" />
...
<Picture src={img3} widths={[200, 400, 900]} sizes="(max-width: 900px) 100vw, 900px" alt="Coolify Plausible Configs" />
...
<Picture src={img4} widths={[200, 400, 900]} sizes="(max-width: 900px) 100vw, 900px" alt="Plausible Secrets" />

After you just need to hit Deploy and Coolify will start deploy the docker containers.

### 3.5 Access Plausible Analytics

After deploy is finished you should go and access Plausible dashbord with the URL you have added in the configs. The first time you will be promted to create a user and a password.

After you create the account you can add your websites. The configs will be stored on the disks with docker volums and in case you redeploy it you will not lose any data.

## Conclusions

This is how you can easely deploy Plausible with the help off Coolify, the config has everything that it needs and you can access it securely with an SSL certificate. In case you want to update it you can do it easely from Coolify interface.
