---
publishDate: 2023-05-11T5:00:00Z
...
I am having a [Plausible](https://plausible.io/) instalation done with docker compose that has almost 1 year since I have updated, it was builed followind the tutorial: [Install Plausible Google Analytics](https://www.wpdoze.com/how-to-install-plausible/) and it has the bellow docker compose file:
...
<Picture src={dockerpull} widths={[200, 400, 900]} sizes="(max-width: 900px) 100vw, 900px" alt="Docker Pull Output" />
...
<Picture src={dockerup} widths={[200, 400, 900]} sizes="(max-width: 900px) 100vw, 900px" alt="Docker Up Output" />
