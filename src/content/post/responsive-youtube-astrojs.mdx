...
<YouTubeEmbed url="https://www.youtube.com/embed/NkShQ1wwiCg" label="Add Responsive YouTube Videos to Astro.JS MDX" />
...
<Picture src={imag1} widths={[200, 400, 900]} sizes="(max-width: 900px) 100vw, 900px" alt="YouTube Speed score" />
